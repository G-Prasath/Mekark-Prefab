...
<body>
    ...
    <div class="page ttm-bgcolor-grey">
        ...
        <!--header end-->
          ...
          <div class="ttm-page-title-row modular-soluation-cover">
                <div class="ttm-page-title-row-inner">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="seprate-service-page">
                                    <h1 class="title">Standard Modular Soluation</h1>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <a href="porta-cabinl" class="btn btn-primary">Read More</a>
                      </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <a href="liftable-cabin" class="btn btn-primary">Read More</a>
                      </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <a href="mi-homes" class="btn btn-primary">Read More</a>
                      </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <a href="k-house" class="btn btn-primary">Read More</a>
                      </div>
                    </div>
                </div>
            </div>
