...
<body>
    ...
    <div class="page ttm-bgcolor-grey">
        ...
        <!--header end-->
            ...
            <div class="ttm-page-title-row contact-cover">
        ...
        <div class="site-main">
                            ...
                            <div class="ttm-bg ttm-col-bgcolor-yes ttm-right-span spacing-12">
                                ...
                                <div class="layer-content">
                                    ...
                                    <div class="padding_top30">
                                        <form action="PHP_Mail/submit_attached.php" method="post" id="contact_form" class="page_form wrap-form clearfix">
                                            <div class="row ttm-boxes-spacing-20px">
                                                ...
                                                <div class="col-md-12">
                                                    <label>
                                                        ...
                                                        <select name="role" id="role" class="col-md-12" required> 
                                                            <option disabled="disabled" selected>Applied Designation</option>
            ...
            <div id="google_map" class="google_map">
                <div class="map_container">
                    <div id="map">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.0556132409197!2d80.21453221426431!3d13.032130517074572!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5267a5e0329dd9%3A0x4235c2dbe32823ec!2sSmart%20Roofs%20and%20Fabs!5e0!3m2!1sen!2sin!4v1679986971473!5m2!1sen!2sin" height="400"></iframe>
                    </div>
                </div>
            </div>
