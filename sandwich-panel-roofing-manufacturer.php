...
<head>
<meta charset="utf-8">
<link rel="canonical" href="https://www.mekarkprefab.com/sandwich-panel-roofing-manufacturer" />
    ...
    <div class="page ttm-bgcolor-grey">
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-12">
                                <div class="seprate-service-page">
                                    <h1 class="title">Sandwich Panels</h1>
                                </div>
        ...
        <div class="container my-5">
            ...
            <div class="row mb-5">
                <div class="col-md-4">
                    <div class="card">
                      <img src="images/projects/sandwich-panels/glasswool-panel.jpg" class="card-img-top" alt="...">
                      <div class="card-body">
                        <h5 class="card-title">Glasswool Panel</h5>
                        ...
                        <a href="glasswool-panel" class="btn btn-primary">Read More</a>
                      </div>
                    </div>
                </div>
            </div>
