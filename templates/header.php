                    ...
                    <div class="row">
                        <div class="col-xl-12 d-flex flex-row align-items-center">
                            <div class="top_bar_contact_item">
                                ...
                                </div>15,62nd street, Ashok Nagar, Chennai-600083
                            </div>
                            <div class="top_bar_contact_item">
                                ...
                                <div class="site-navigation d-flex flex-row align-items-center justify-content-between">
                                    ...
                                    <div class="d-flex flex-row">
                                        ...
                                        <div class="header_extra d-flex flex-row align-items-center justify-content-end">
                                            <div class="header_btn" data-toggle="modal" data-target="#exampleModal">
                                                <a href="javacsript:;" class="btn ttm-btn ttm-btn-size-md ttm-btn-shape-round ttm-btn-style-fill ttm-icon-btn-right ttm-btn-color-skincolor" data-toggle="modal" data-target="#modalContactForm">Get a Quote </a>

                                            </div> 
                                        </div>
                                        <!-- <button type="button" id="myModal" class="btn btn-info m-4">Done</button> -->
        ...
        <div class="modal fade form-bg" id="modalContactForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <form action="mail" method="post" id="enquiry">
